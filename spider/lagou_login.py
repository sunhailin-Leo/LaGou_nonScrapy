...
def get_password(pass_wd: str) -> str:
    """
    这里对密码进行了md5双重加密 veennike 这个值是在main.html_aio_f95e644.js文件找到的
    """
    pass_wd = hashlib.md5(pass_wd.encode('utf-8')).hexdigest()
...
def login(user: str, pass_wd: str):
    x__anti__forge__token, x__anti__forge__code = get_token()
